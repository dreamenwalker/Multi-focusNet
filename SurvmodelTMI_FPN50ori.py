...
def identity_block(input_tensor, kernel_size, filters, stage, block,use_bias=True, train_bn=True):
    ...
    x = Conv2D(filters1, (1, 1), name=conv_name_base + '2a', kernel_initializer="he_normal",
...
def resnet_self(input_tensor = None, include_top=True,num_outputs=1,
    ...
    x = KL.Conv2D(64, (7, 7), strides=(2, 2), name='conv1', use_bias=True, kernel_initializer="he_normal",
                      kernel_regularizer=L12_reg)(x)
    ...
    for i in range(block_count):
        x = identity_block(x, 3, [256, 256, 1024], stage=4, block=chr(98 + i), train_bn=train_bn)#chr(98) is b
    C4 = x
    # Stage 5
    if stage5:
...
# 从 C5开始处理，先卷积来转换特征图尺寸
    ...
    C3_input = KL.Conv2D(512, (1, 1), name='fpn_C2toC3',kernel_regularizer=L12_reg)(pool2)
    #c3 out 28*28*512
    C3_output = KL.Add(name="fpn_C2addC3")([C3,C3_input])
    #stage 4
    pool34 = MaxPooling2D(pool_size=(2, 2))(C3_output)
    C4_input = KL.Conv2D(1024, (1, 1),  kernel_initializer="he_normal",name='fpn_C3toC4')(pool34)
    #c4 out 14*14*1024
    C4_output = KL.Add(name="fpn_C3addC4")([C4,C4_input])
    # stage 5 C5 output 7*7*2048
    pool45 = MaxPooling2D(pool_size=(2, 2))(C4_output)
    C5_input = KL.Conv2D(2048, (1, 1),  kernel_initializer="he_normal",name='fpn_C4toC5')(pool45)
...
if __name__ == '__main__':
    ...
    plot_model(model50,to_file='./resnet50FPN525removeCbranch.pdf',show_shapes=True)
