...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  1 09:45:52 2020
@author: dreamen
"""
...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  1 09:40:20 2020
...
def snet(pretrained_weights = None, input_shape = (160,160,3), num_classes=1):
    ...
    # x_newfc = Dense(num_classes, activation='tanh', name='newfc')(added)
...
# ————————————————
# 版权声明：本文为CSDN博主「李宜君」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
# 原文链接：https://blog.csdn.net/wwwlyj123321/article/details/103703506
if __name__ == '__main__':
    from keras.utils import plot_model
    model = snet()
    plot_model(model, to_file='model519.pdf',show_shapes=True,show_layer_names=True)
