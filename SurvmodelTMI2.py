...
# 从 C5开始处理，先卷积来转换特征图尺寸
    ...
    P4 = KL.Add(name="fpn_p5addc4")([
                ...
                KL.Conv2D(256, (1, 1),name='fpn_c4p4')(C4)])#503 256 >128
    ...
    P2 = KL.Add(name="fpn_p3addc2")([
                ...
                KL.Conv2D(64, (1, 1),  kernel_initializer="he_normal",name='fpn_c2p2')(C2)])
    ...
    P1 = KL.Add(name = "fpn_p2addc1")([KL.UpSampling2D(size=(2, 2),name="fpn_p2upsampled")(P2),
    KL.Conv2D(32, (1, 1), name='fpn_c1p1')(C1)])# change channel 64 to 256 for C1
    ...
    '''
    gpP1 = KL.GlobalAveragePooling2D(dim_ordering='default', name='global_poolP1')(P1)
    merge1 = KL.concatenate([gpP1,gpP2,gpP3,gpP4,gpP5,featureall2])
...
if __name__ == '__main__':
    ...
    os.chdir('/data/zlw/survival1/TMI/plotmodel/') 
    plot_model(model50,to_file='./FPNmultifocus508.pdf',show_shapes=True)
